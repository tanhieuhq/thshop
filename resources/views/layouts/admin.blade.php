...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/h5zeor77grzbw3sqp1bb5z3y4n213y59vuzsh3qo7m6l68t5/tinymce/5/tinymce.min.js"
        referrerpolicy="origin"></script>
    <script>
        var editor_config = {
            path_absolute: "http://localhost/thshop/",
            selector: 'textarea',
            relative_urls: false,
            plugins: [
                ...
                <ul id="sidebar-menu">
                    ...
                    <li class="nav-link {{ $module_active == 'product' ? 'active' : '' }}">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="{{ url('admin/productcat/list') }}">Danh mục</a></li>
                        </ul>
                    </li>
