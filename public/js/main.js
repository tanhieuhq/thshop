$(document).ready(function () {
    ...
    //  Ajax
    $('#num-order-cart.num-order').change(function () {
        var rowId = $(this).attr("data-id");
        var quantity = $(this).val();
        var data = { quantity: quantity, rowId: rowId };
        $.ajaxSetup({
            headers: {
        ...
        $.ajax({
            ...
            success: function (data) {
                // console.log(data);
                $("#amount-" + rowId).text(data.amount);
                $("#total-price span").text(data.amount_total);
            },
    ...
    //    $("#list-thumb .list-thumb-item").click(function () {
    //        picture_src = $(this).find('img').attr('src');
    //        $('#main-thumb img').attr('src', picture_src);
    //        $('#main-thumb img').attr('data-zoom-image', picture_src);
    //    });
